...
export const PROJECTS: IProject[] = [
    {
        title: 'Brandix.ai',
        slug: 'brandix-ai',
        liveUrl: 'https://brandix-ai-tau.vercel.app/',
        year: 2025,
        description: `
    Brandix.ai is an AI-powered brand kit generator that creates complete brand identities instantly. Simply describe your business and get a professional brand name, tagline, color palette, mission statement, logo and brand images — all generated by AI in seconds. <br/><br/>
  
    Key Features:<br/>
    <ul>
      <li>🤖 AI-Powered Generation: Uses Llama 3.3 (70B) via Groq Cloud for ultra-fast brand creation</li>
      <li>🎨 Complete Brand Kits: Brand name, tagline, mission, personality keywords, color palette, and logo</li>
      <li>🖼️ Free Image Generation: Pollinations.ai integration (no API key needed)</li>
      <li>✨ Modern UI: Glassmorphism design with smooth animations</li>
      <li>👁️ Instant Preview: See your brand come to life in real-time</li>
      <li>📥 Copy & Download: Easy export of logo and brand kit images in ZIP file</li>
    </ul><br/>
  
    Technical Highlights:
    <ul>
      <li>Built with Next.js 16 App Router for optimal performance</li>
      <li>TypeScript for type safety and better developer experience</li>
      <li>Groq Cloud integration for lightning-fast AI text generation</li>
      <li>Pollinations.ai for completely free image generation</li>
      <li>Zod schema validation for robust data handling</li>
      <li>Modern vanilla CSS with custom design system</li>
    </ul>
  `,
        role: `
    Full Stack Developer <br/>
    Led the complete development of Brandix.ai from concept to deployment:<br/>
    <ul>
      <li>🎨 UI/UX: Designed a modern glassmorphism interface with smooth animations using vanilla CSS</li>
      <li>🤖 AI Integration: Integrated Groq Cloud API with Llama 3.3-70B for brand generation</li>
      <li>🖼️ Image Generation: Implemented Pollinations.ai for free logo and brand image creation</li>
      <li>📋 Form Validation: Built robust input validation with Zod schemas</li>
      <li>🏗️ Architecture: Structured the app using Next.js 16 App Router with TypeScript</li>
      <li>🚀 Deployment: Deployed on Vercel with optimized build configuration</li>
    </ul>
  `,
        techStack: [
            'Next.js 16',
        ...
        thumbnail: '/projects/long/brandix-ai.png',
        longThumbnail: '/projects/long/brandix-ai.png',
        images: ['/projects/images/brandix-ai-1.png'],
    },
    {
        title: 'InkSync',
        slug: 'inksync',
